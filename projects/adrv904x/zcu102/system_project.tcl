...
# e.g.
#   RX-OS disabled:        make
#   RX-OS LinkSharing:     make ORX_ENABLE=1 LINK_SHARING=1 RX_OS_JESD_M=16 RX_OS_JESD_L=8 RX_OS_JESD_S=1 RX_OS_JESD_NP=16
...
#   LINK_SHARING : Chose between NLS and LS mode
...
adi_project adrv904x_zcu102 0 [list \
  ...
  LINK_SHARING    [get_env_param LINK_SHARING       0] \
