...
ad_xcvrcon util_adrv904x_xcvr axi_adrv904x_tx_xcvr axi_adrv904x_tx_jesd {0 1 2 3 7 6 5 4} {} adrv904x_tx_device_clk $TX_NUM_OF_LANES {}
...
if {$RX_NUM_OF_LANES == 8} {
  ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_xcvr axi_adrv904x_rx_jesd {} {} adrv904x_rx_device_clk $RX_NUM_OF_LANES {7 6 4 5 2 0 1 3}
    ...
    if {$RX_NUM_OF_LANES == 4} {
      ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_xcvr axi_adrv904x_rx_jesd {} {} adrv904x_rx_device_clk $RX_NUM_OF_LANES {7 6 4 5}
    } else {
        if {$RX_NUM_OF_LANES == 2} {
          ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_xcvr axi_adrv904x_rx_jesd {} {} adrv904x_rx_device_clk $RX_NUM_OF_LANES {7 6}
        } else {
            ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_xcvr axi_adrv904x_rx_jesd {} {} adrv904x_rx_device_clk $RX_NUM_OF_LANES {7}
        }
    }
}
...
# Rx - OBS
  ...
  if {$RX_OS_NUM_OF_LANES == 4} {
    ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_os_xcvr axi_adrv904x_rx_os_jesd {4 5 6 7} {} adrv904x_rx_os_device_clk $RX_OS_NUM_OF_LANES {2 0 1 3}
  } else {
      if {$RX_OS_NUM_OF_LANES == 2} {
        ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_os_xcvr axi_adrv904x_rx_os_jesd {4 5 6 7} {} adrv904x_rx_os_device_clk $RX_OS_NUM_OF_LANES {2 0}
      } else {
        ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_os_xcvr axi_adrv904x_rx_os_jesd {4 5 6 7} {} adrv904x_rx_os_device_clk $RX_OS_NUM_OF_LANES {2}
      }
  }
...
if {$ORX_ENABLE} {
  if {!$LINK_SHARING} {
    ...
    ad_connect  adrv904x_rx_device_clk rx_os_adrv904x_tpl_core/link_clk
    ad_connect  axi_adrv904x_rx_jesd/rx_sof rx_os_adrv904x_tpl_core/link_sof
    ad_connect  axi_adrv904x_rx_jesd/rx_data_tdata rx_os_adrv904x_tpl_core/link_data
    ad_connect  axi_adrv904x_rx_jesd/rx_data_tvalid rx_os_adrv904x_tpl_core/link_valid

    ad_connect  adrv904x_rx_device_clk util_adrv904x_rx_os_cpack/clk
    ad_connect  adrv904x_rx_device_clk_rstgen/peripheral_reset util_adrv904x_rx_os_cpack/reset
    ad_connect  adrv904x_rx_device_clk axi_adrv904x_rx_os_dma/fifo_wr_clk
  }
...
#     C_OPERATION {or} \
#   ]
#   ad_ip_parameter rx_os_adrv9026_tpl_core/adc_tpl_core CONFIG.EXT_SYNC 1
#   ad_connect ext_sync_in rx_os_adrv9026_tpl_core/adc_tpl_core/adc_sync_in
#   ad_connect rx_os_adrv9026_tpl_core/adc_tpl_core/adc_sync_manual_req_out manual_orx_sync_or/Op1
#   ad_connect manual_sync_or/Res manual_orx_sync_or/Op2
#   ad_connect manual_orx_sync_or/Res rx_adrv9026_tpl_core/adc_tpl_core/adc_sync_manual_req_in
#   ad_connect manual_orx_sync_or/Res tx_adrv9026_tpl_core/dac_tpl_core/dac_sync_manual_req_in
#   ad_connect manual_orx_sync_or/Res rx_os_adrv9026_tpl_core/adc_tpl_core/adc_sync_manual_req_in
# } else {
#   ad_connect manual_sync_or/Res rx_adrv9026_tpl_core/adc_tpl_core/adc_sync_manual_req_in
#   ad_connect manual_sync_or/Res tx_adrv9026_tpl_core/dac_tpl_core/dac_sync_manual_req_in
# }
