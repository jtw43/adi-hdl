...
set dac_offload_name tx_data_offload
...
set adc_offload_name rx_data_offload
...
ad_ip_parameter axi_adrv9009_som_tx_dma CONFIG.MAX_BYTES_PER_BURST 4096
...
ad_ip_parameter axi_adrv9009_som_rx_dma CONFIG.ID 0
...
ad_connect rx_adrv9009_som_tpl_core/adc_tpl_core/adc_rst cpack_reset_logic/op1
ad_connect rx_do_rstout_logic/res cpack_reset_logic/op2
ad_connect cpack_reset_logic/res util_som_rx_cpack/reset
...
ad_connect $adc_offload_name/m_axis axi_adrv9009_som_rx_dma/s_axis
ad_connect $adc_offload_name/init_req axi_adrv9009_som_rx_dma/s_axis_xfer_req

# TX offload - DDR

ad_connect ddr4_1/c0_ddr4_aresetn ddr4_1_rstgen/peripheral_aresetn
ad_connect $dac_offload_name/storage_unit/MAXI_0 ddr4_1/C0_DDR4_S_AXI
ad_connect $dac_offload_name/storage_unit/m_axi_aclk ddr4_1/c0_ddr4_ui_clk
ad_connect $dac_offload_name/storage_unit/m_axi_aresetn ddr4_1_rstgen/peripheral_aresetn
ad_connect $dac_offload_name/i_data_offload/ddr_calib_done ddr4_1/c0_init_calib_complete
...
ad_connect core_clk_a $adc_offload_name/m_axis_aclk

ad_connect core_clk_a_rstgen/peripheral_aresetn $adc_offload_name/s_axis_aresetn
ad_connect core_clk_a_rstgen/peripheral_aresetn $adc_offload_name/m_axis_aresetn

ad_connect core_clk_a  $dac_offload_name/m_axis_aclk
ad_connect sys_dma_clk $dac_offload_name/s_axis_aclk
ad_connect core_clk_a_rstgen/peripheral_aresetn $dac_offload_name/m_axis_aresetn
ad_connect sys_dma_resetn $dac_offload_name/s_axis_aresetn
ad_connect sys_cpu_resetn $dac_offload_name/s_axi_aresetn
ad_connect util_som_tx_upack/s_axis $dac_offload_name/m_axis

ad_connect sys_dma_clk axi_adrv9009_som_tx_dma/m_axis_aclk
ad_connect $dac_offload_name/init_req axi_adrv9009_som_tx_dma/m_axis_xfer_req
ad_connect $dac_offload_name/s_axis axi_adrv9009_som_tx_dma/m_axis
